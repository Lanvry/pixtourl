...
export const StaggeredMenu = ({
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // FIX: Set display none ketika menu ditutup
      if (!openRef.current) {
        gsap.set([panel, ...preLayers], { 
          xPercent: offscreen,
          display: "none" // Tambahkan display none
        });
      } else {
        gsap.set([panel, ...preLayers], { 
          xPercent: offscreen,
          display: "block" // Pastikan display block ketika terbuka
        });
      }
  ...
  const buildOpenTimeline = useCallback(() => {
    ...
    // FIX: Set display block sebelum animasi dimulai
  ...
  const playClose = useCallback(() => {
    ...
    closeTweenRef.current = gsap.to(all, {
      ...
      overwrite: "auto",
      onComplete: () => {
        // FIX: Set display none setelah animasi selesai
