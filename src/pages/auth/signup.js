            ...
            <div className="brand-content">
              ...
              <div className="brand-hero">
                <h1 className="brand-title">
                  Turn Your Images Into Shareable URLs — Instantly
                </h1>
                <p className="brand-subtitle">
                  Join thousands of users who trust us with their precious
                  memories. Secure, fast, and unlimited cloud storage.
                </p>
              </div>
            ...
            >
              ...
              >
                ...
                >
                  {/* Username Field */}
                  <motion.div
                    className="form-group cursor-target"
                    variants={itemVariants}
                  >
                  ...
                  <motion.button
                    type="submit"
                    className={`signup-button cursor-target readmore ${
                      isLoading ? "loading" : ""
                    }`}
                    disabled={isLoading}
                    variants={itemVariants}
                  ...
                  <motion.div className="login-link" variants={itemVariants}>
                    <p>
                      ...
                      <Link to="/auth/login" className="link cursor-target">
                        Sign In
                      </Link>
                    </p>
                  </motion.div>
